...
Friction Reduction: Survey completion dropped to 37.5% due to the friction of clicking an external Google Form link. Future versions will integrate Discord Reaction Emojis for frictionless, in-app data collection.
